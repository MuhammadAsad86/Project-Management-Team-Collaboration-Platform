        ...
        >
          ...
          >
            ...
            <div className="relative flex items-center">
              <span className="pointer-events-none absolute left-3.5 flex items-center text-slate-400">
                <svg
                  className="h-4 w-4"
                  fill="none"
                  stroke="currentColor"
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={loading}
              className="flex w-full cursor-pointer items-center justify-center rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-xs font-semibold text-white shadow-md shadow-indigo-500/25 transition-all hover:opacity-95 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm"
              style={{
                padding: "12px 20px",
                gap: "8px",
              }}
